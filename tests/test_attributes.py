...
class TestAttributes(unittest.TestCase):
    def test_str(self):
        ...
        self.assertEqual(
            str(Attributes(pmin=1, pmax=2, lt=3, st=4, gt=5)), "[1,2]3:4:5"
        )
    ...
    def test_from_string(self):
        ...
        self.assertEqual(
            Attributes(pmin=1, pmax=2), Attributes.from_string("[1,2]")
        )
        ...
        self.assertEqual(
            Attributes(lt=3, st=4, gt=5), Attributes.from_string("3:4:5")
        )
        self.assertEqual(
            Attributes(pmin=1, pmax=2, lt=3, st=4, gt=5),
            Attributes.from_string("[1,2]3:4:5"),
        )
